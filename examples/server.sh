...
# ML-DSA cert auth (use -V: no CRLs are generated for the PQC certs):
#   ./examples/server.sh -v 4 -pqc X25519MLKEM768 -V \
#       -c ../certs/pqc/server-mldsa87.pem \
#       -k ../certs/pqc/server-mldsa87-priv.pem \
